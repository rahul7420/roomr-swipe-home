...
const Home = () => {
  ...
  return (
    <div className="min-h-screen pb-16">
      <div className="bg-gradient-to-br from-primary to-secondary p-6 pt-10">
          ...
          <div className="grid grid-cols-2 gap-4">
            <Card className="bg-white/10 backdrop-blur-sm border-0 shadow-lg">
              <CardContent className="p-4 flex items-center">
                ...
                <div>
                  <p className="text-xs text-white/70">Saved Apartments</p>
                      ...
                      <div className="mt-3 flex">
                        <div className="w-1/3">
                          <img 
                            ...
                            className="w-full h-20 object-cover rounded-l-md"
                          />
                        </div>
                        <div className="w-2/3 bg-muted p-2 rounded-r-md">
                          <h4 className="text-sm font-medium line-clamp-1">{match.apartment.title}</h4>
                      ...
                      <div className="flex">
                        <div className="w-1/3">
                          <img 
                            ...
                            alt={apartment.title} 
                            className="w-full h-24 object-cover rounded-l-md"
                          />
                        </div>
                        <div className="w-2/3 p-3">
                          <h3 className="font-medium line-clamp-1">{apartment.title}</h3>
